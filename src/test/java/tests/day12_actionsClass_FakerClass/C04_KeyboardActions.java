...
public class C04_KeyboardActions extends TestBase_Each {
    ...
    public void test01(){
        ...
        String expectedIsimIcereik = "DELL Core I3";
        String actualIsimIcerik = urunIsimElementi.getText();

        Assertions.assertTrue(expectedIsimIcereik.contains(actualIsimIcerik));
