...
public class C03__Assertions {
    ...
    public void titleTest(){
        ...
        String unExpectedTitleİcerik = "Rest";

        Assertions.assertFalse(actualTitle.contains(unExpectedTitleİcerik), "title istenmeyen Rest kelimesini içeriyor");
    ...
    public void logoTest(){
        ...
        Assertions.assertTrue(logoElementi.isDisplayed(), "Logo görünmüyor");
